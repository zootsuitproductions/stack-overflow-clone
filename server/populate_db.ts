...
import { Answer, Comment, Question, Tag, User } from './types/types';
import {
  Q1_DESC,
  Q1_TXT,
  Q2_DESC,
...
async function userCreate(username: string, password: string, dateJoined: Date): Promise<User> {
...
const populate = async () => {
  try {
    await userCreate('sana', 'sanaPassword', new Date('2023-12-11T03:30:00'));
    await userCreate('ihba001', 'SomePassword#123', new Date('2022-12-11T03:30:00'));
    await userCreate('saltyPeter', 'VeryStrongPassword#!@', new Date('2023-12-11T03:30:00'));
    await userCreate('monkeyABC', 'password', new Date('2023-11-11T03:30:00'));
    await userCreate('hamkalo', 'redapplecar', new Date('2023-12-02T03:30:00'));
    await userCreate('azad', 'treeorangeBike', new Date('2023-06-11T03:30:00'));
    await userCreate('abhi3241', '112@realpassword', new Date('2023-01-12T03:30:00'));
    await userCreate('Joji John', 'jurassicPark#12', new Date('2023-10-11T03:30:00'));
    await userCreate('abaya', 'letmein', new Date('2023-04-20T03:30:00'));
    await userCreate('mackson3332', 'TrIcKyPhRaSe', new Date('2023-07-26T03:30:00'));
    await userCreate('alia', 'correcthorsebatterystaple', new Date('2023-03-19T03:30:00'));
